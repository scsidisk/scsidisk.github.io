...
- Brew OSX包管理，已经安装下面软件 [(主页安装)](http://brew.sh/)
    + brew install asciidoc bash-completion ctags curl htop-osx imagemagick libmemcached mongodb node nvm pandoc pyenv redis thrift tree wget go
...
- brew-cask 使用
    ...
    + brew cask install appcleaner colorpicker enpass evernote filezilla folx gitter google-chrome lantern mplayer-osx-extended mplayerx private-eye rcdefaultapp rowanj-gitx sequel-pro shadowsocksx sogouinput squirrel sublime-text3 the-archive-browser the-unarchiver thunder xmind
...
- opendiff 安装xcode以后包含GUI。
- Xcode apple公司的开发工具，(Mac App Store 下载)
...
- Filezilla [(brew-cask 安装)](js:return false;) FTP客户端
- Folx [(Mac App Store 下载)](https://itunes.apple.com/cn/app/folx-go/id736584830?mt=12)
- Rumpus -- FTP服务器
...
- [商]Navicat Premium 综合数据库管理软件(MSSQL, Orocle, MySQL, SQLite) [(下载)](http://soft.macx.cn/soft5696.htm)
...
- [商]Adobe Photoshop CS6
- Axure RP Pro
- XMind -- 漂亮(java程序)  [(brew-cask 安装)](js:return false;)
- [商]Mindjet -- Mac原生程序,不需要java (以前叫MindManager)
- [商]Pixelmator
- [商]OmniGraffle
- Xee
- Web Snapper -- 网页保存
...
- [商]iWork 安装低版本以后可以升级
- [商]Microsoft Office 2011 如果 iWork 够用，可以不安装
- [商]iDocument -- 文档管理
...
- Doxygen
- [商]Dash 查看文档利器 [(Mac App Store 下载)](https://itunes.apple.com/cn/app/dash-docs-snippets/id458034879?mt=12)
- OmegaT+
...
- [商]zoc6 不错的 ssh 客户端，也可以使用 SecureCRT。
