...
- Brew OSX包管理，已经安装下面软件 [(主页安装)](http://brew.sh/)
	+ brew install wget go maven pandoc redis rename tree asciidoc
...
- brew-cask 使用
	...
	+ brew cask install appcleaner burn difffork eclipse-java filezilla rowanj-gitx mongohub mou netnewswire sequel-pro time-out tunnelblick yep simpless thunder xmind ichm unpkg
